...
import CustomSoloCreatable from 'src/pages/services/nms/CustomSoloCreatable'
// Define initial state structure
const initialState = {
  intervention: {
    during_survey: {
      question_1: { quesiton: '', answer: '' },
      question_2: { quesiton: '', answer: '' },
      question_3: { quesiton: '', answer: '' },
      question_4: { quesiton: '', answer: '' },
      question_5: { quesiton: '', answer: '' },
      question_6: { quesiton: '', answer: '' },
      question_7: { quesiton: '', answer: '' },
      question_8: { quesiton: '', answer: '' }
    },
    post_survey: {
      matters_identified: [],
      outcomes_provided: {
...
const NMServiceForm = ({ state, setState, onSubmit, onServiceUpdate }) => {
  ...
  React.useEffect(() => {
    ...
    console.log('NMServiceForm serviceInfo looks like...', state)
    setLoading(false)
  }, [state])
    ...
    setState(prevState => ({
      ...
      [stage]: {
        ...
        during_survey: {
          ...
          [question]: {
            ...prevState[stage].during_survey[question],
      ...
      {questions.map((question, index) => (
        <>
          ...
          <TextField
            ...
            value={state[stage].during_survey[`question_${index + 1}`].answer}
  ...
  return (
    <Box>
      ...
      <Button variant='contained' color='primary' onClick={onServiceUpdate}>
        Submit
      </Button>
    </Box>
  )
