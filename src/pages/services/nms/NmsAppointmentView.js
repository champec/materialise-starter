...
import PreviewCardBooking from '../list/PreviewCardBooking'
import AppointMentChat from '../list/AppointMentChat'
import NmsBox from './NmsBox'

const NmsAppointmentView = ({ appointment }) => {
  // ** State
  ...
  const getActiveTab = () => {
    switch (activeTab) {
      case 'booking':
        return <PreviewCardBooking booking={appointment} />
      case 'chat':
        return <AppointMentChat appointment={appointment} />
      case 'nms':
        return <NmsBox nms={appointment} />
      default:
        return <PreviewCardBooking booking={appointment} />
    }
  }
...
export default NmsAppointmentView
