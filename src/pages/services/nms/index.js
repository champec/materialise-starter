...
import AppointmentView from '../list/AppointmentView'
import NmsAppointmentView from './NmsAppointmentView'
...
import BatchActionsModal from '../list/BatchActionsModal'
...
const NMSList = () => {
  ...
  useEffect(() => {
    dispatch(fetchAppointments({ type: 'nms', table: 'service_nms' }))
  }, [])
  ...
  return (
    <DatePickerWrapper>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <CardHeader title='New Medicines Service' />
            <CardContent>
              <Grid container spacing={6}>
        ...
        >
          ...
          >
            ...
            <NmsAppointmentView appointment={appointment} />
          </DialogContent>
        </Dialog>
        <BatchActionsModal
          open={batchModalOpen}
